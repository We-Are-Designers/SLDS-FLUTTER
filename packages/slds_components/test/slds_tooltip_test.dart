...
void main() {
  ...
  testWidgets('title-only renders the compact pill, no description/footer', (tester) async {
  ...
  testWidgets('title + description renders the full card without a footer when unset', (tester) async {
    await pump(
      tester,
  ...
  testWidgets('renders step label, action button and close button when all set', (tester) async {
    var actioned = false;
    var closed = false;
    await pump(
      tester,
