...
@widgetbook.UseCase(name: 'Playground', type: SldsTextField, path: '[Forms & Inputs]')
Widget buildSldsTextFieldUseCase(BuildContext context) {
  final label = context.knobs.string(label: 'Label', initialValue: 'Email');
  final hintText = context.knobs.string(label: 'Hint', initialValue: 'info@example.com');
  ...
  final showLeadingIcon = context.knobs.boolean(label: 'Leading icon', initialValue: true);
