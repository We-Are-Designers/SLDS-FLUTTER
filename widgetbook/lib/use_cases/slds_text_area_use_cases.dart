...
@widgetbook.UseCase(name: 'Playground', type: SldsTextArea, path: '[Forms & Inputs]')
Widget buildSldsTextAreaUseCase(BuildContext context) {
  final label = context.knobs.string(label: 'Label', initialValue: 'Description');
  final hintText = context.knobs.string(label: 'Hint', initialValue: 'Description placeholder');
  ...
  final maxLength = context.knobs.int.input(label: 'Max length', initialValue: 300);
