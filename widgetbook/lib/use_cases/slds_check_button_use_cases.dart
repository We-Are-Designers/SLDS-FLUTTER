...
@widgetbook.UseCase(name: 'Playground', type: SldsCheckButton, path: '[Forms & Inputs]')
Widget buildSldsCheckButtonUseCase(BuildContext context) {
  final label = context.knobs.string(label: 'Label', initialValue: 'Option One');
  final isEnabled = context.knobs.boolean(label: 'Enabled', initialValue: true);

  return Padding(
    padding: const EdgeInsets.all(24),
    child: SizedBox(width: 220, child: _CheckButtonDemo(label: label, enabled: isEnabled)),
  );
}
